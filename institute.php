		...
		<div class="content">
			<div class="container-fluid">
				<div class="d-flex justify-content-end mb-3">
					<a class="btn-sm btn-info" href="register_institute.php">
						Register Institute
					</a>
				</div>
				<div class="table-responsive-sm rounded" style="height: 500px; overflow-y: auto;">
					<table class="table table-light table-striped rounded table-hover ">
						<caption>List of institute</caption>
...
<script>
	$(function() {
					...
					if (res.success) {
                        ...
                        <tr>
                            <td colspan="6" class="text-center">
                                <p class="card-text">No Registered Institute!</p>
                            </td>
                        </tr>
                    `);
					}
		...
		const generateRowMarkup = (data) => {
			...
			const description = data.description == null ? "No description" : data.description;
			const color = data.description == null ? "text-secondary" : "text-dark";
			return `<tr>
					<td class="align-middle">${data.title}</td>
                    <td class="align-middle">${data.slug}</td>
                    <td class="align-middle ${color}">${description}</td>
					<td class="align-middle d-flex align-items-center">
                        <a href="edit_institute.php?id=${data.id}" class="mr-2">
